...
(function (L09_Canvas) {
    ...
    function init(_event) {
        ...
        // H�he und Breite des Canvas bestimmen
        ...
        // Luftblasen
        for (let i = 0; i < 12; i++) {
            let x = Math.random() * (400 - 350) + 25;
            let y = Math.random() * (600 - 250) + 50;
            drawBubble(x, y);
        }
        // Sand
        drawSand(0, 500);
        ...
        // Postition Fisch
        drawFish(50, 50);
        // Schleife f�r zuf�llige Anordnung der Fische
        for (let i = 0; i < 3; i++) {
    ...
    function drawFish(_x, _y) {
        ...
        crc2.stroke();
        /*crc2.fillStyle = "rgb(255, 237, 210)"; // Wenn ich die Fische ausf�lle, deformieren sie sich :(
        crc2.fill();*/
    }
